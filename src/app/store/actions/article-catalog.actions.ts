...
export const createArticleFailure = createAction('[Catalog] Create Failure', props<{ error: string }>());
export const loadCategories = createAction('[Catalog] Load Categories');
export const loadCategoriesSuccess = createAction('[Catalog] Load Categories Success', props<{ categories: ArticleCategory[] }>());
